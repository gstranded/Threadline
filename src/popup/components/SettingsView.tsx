...
export function SettingsView({ onBack, onAllDeleted, width }: SettingsViewProps) {
  ...
  return (
    <div style={{ ...S.viewContainerLoose, ...(width != null ? { width, minWidth: 0 } : {}), minHeight: '100%', backgroundColor: tk.bg, color: tk.text }}>
      {/* Header */}
